...
trait AppMenu {
  ...
  def menuBar = {
    ...
    mathActivityMenu.add(menuItemFor(Utils.loadString("S_CountingGame"), "counting.kojo", "/mathgames/"))
    mathActivityMenu.add(menuItemFor(Utils.loadString("S_MakeFractions"), "make-fractions.kojo", "/mathgames/"))
    mathActivityMenu.add(menuItemFor(Utils.loadString("S_IdentifyFractions"), "identify-fractions.kojo", "/mathgames/"))
...
<div style="font-size: 12pt; font-family: Verdana, 'Verdana CE',  Arial, 'Arial CE', 'Lucida Grande CE', lucida, 'Helvetica CE', sans-serif; ">
              ...
              Copyright &copy; 2009-2016 Lalit Pant (pant.lalit@gmail.com) and the Kojo Dev Team.<br/><br/>
