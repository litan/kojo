...
var ok = götür(-2 * yy, yy) * kalemRengi(siyah) -> Resim.düz(yy, 0)
çiz(ok)
...
var izDüşümüX = götür(0, 0) -> Resim.düz(1, 1); çiz(izDüşümüX)
var kayanEksenX = götür(0, 0) -> Resim.düz(1, 1); çiz(kayanEksenX); kayanEksenX.gizle()
...
var izDüşümüY = götür(0, 0) -> Resim.düz(1, 1); çiz(izDüşümüY)
var kayanEksenY = götür(0, 0) -> Resim.düz(1, 1); çiz(kayanEksenY); kayanEksenY.gizle()
