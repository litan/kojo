...
class TurtleTest {
  ...
  def testManyForwards: Unit = {
    ...
    assertTrue(SCTest.check(default, propForward).passed)
  }
  ...
  def testManyTurns: Unit = {
    ...
    assertTrue(SCTest.check(default, propTurn).passed)
  }
  ...
  def testManyTowardsQ1: Unit = {
    ...
    assertTrue(SCTest.check(default, propTowards).passed)
  }
  ...
  def testManyMoveTos: Unit = {
    ...
    assertTrue(SCTest.check(default, propMoveTo).passed)
  }
  ...
  //      }
  //    }
  //    assertTrue(SCTest.check(default, propPerimeter).passed)
  //  }
